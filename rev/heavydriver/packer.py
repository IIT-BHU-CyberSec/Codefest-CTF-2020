...
def main(argv):
  ...
  for i in xrange(text_size):
    packed[text_offset + i] = packed[text_offset+i]^0xc2
    packed[text_offset + i] = packed[text_offset+i]^0xa5
    packed[text_offset + i] = packed[text_offset+i]^0xb3
    packed[text_offset + i] = packed[text_offset+i]^0xe2


  MAGIC_OFFSET = 0xb2c5f
